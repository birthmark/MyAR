...
//    }()
    ...
    static let availableObjects: [VirtualTextObjectDefinition] = [
        VirtualTextObjectDefinition(text: "拓天伟业", fontname: "Futura-CondensedExtraBold", size: 0.2, extrusionratio: 0.5, isWrapped: false),
        VirtualTextObjectDefinition(text: "拓天速贷", fontname: "Futura-CondensedExtraBold", size: 0.2, extrusionratio: 0.5, isWrapped: true)
    ]
